...
public class Espectador {
	...
	/**
	 * Indicamos si el espectador tiene dinero (en el video estaba en la clase cine
	 * tiene mas sentido que sea un metodo del espectador)
	 *
	 * @param precioEntrada
	 * @return
	 */
	...
	public String toString() {
		return "el nombre del espectador es " + nombre + " de " + edad + " años y con " + dinero
