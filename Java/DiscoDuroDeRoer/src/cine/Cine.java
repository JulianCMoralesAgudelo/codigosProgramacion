...
public class Cine {
	...
	/**
	 * Indicamos si el espectador cumple lo necesario para entrar: - Tiene dinero -
	 * Tiene edad El tema de si hay sitio, se controla en el main
	 *
	 * @param e
	 * @return
	 */
	public boolean sePuedeSentar(Espectador cliente) {
		return cliente.tieneDinero(precio) && cliente.tieneEdad(pelicula.getEdadMininma());
	}
	...
	public void sentar(int fila, char letra, Espectador cliente) {
		getAsiento(fila, letra).setEspectador(cliente);
	}
