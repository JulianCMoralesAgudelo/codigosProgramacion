...
public class ListasMultidimencionales {
	...
	public static void main(String[] args) {
		...
		// Iteración en cada subconjunto para encontrar las sumas de cada subconjunto y
		...
		// Iteración en cada subconjunto para encontrar el numero mayor y menor de la
