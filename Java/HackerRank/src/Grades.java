...
/*
 * Si la diferencia entre la calificaci�n y el siguiente m�ltiplo de 5 es menor
 * que, 3 redondea la calificaci�n hasta el siguiente m�ltiplo de 5. Si el valor
 * de la calificaci�n es inferior a 38, no se produce redondeo ya que el
 * resultado seguir� siendo una calificaci�n reprobatoria.
 * 
 */
