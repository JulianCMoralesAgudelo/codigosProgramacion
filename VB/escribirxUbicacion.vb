...
'Script          : escribirxUbicacion.vb
'Fecha           : 29/09/2022
'Autor:          : Julián Camilo Morales Agudelo <juliancmorales10@gmail.com>
'Actulizacion    :
'Versión         : 1.0
'Modificado      :
'Descripcion     : Este archivo busca la ubicacion especifica de la celda u archivo, el otro archivo debe de estar abierto en el modelo de datos.

'**************************************************************************************************************************************************************

Sub escribirxUbicacion()
